...
function ctreeLoad(scene, renderer) {
    ...
    loader.load(
        ...
        function (gltf) {
            ...
            originalTree.scale.set(0.2, 0.2, 0.2);
            ...
            treeClone2.scale.set(0.2, 0.2, 0.2);
            ...
            console.log('coco Tree and clones loaded successfully!');
        },
        function (xhr) {
